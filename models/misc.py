...
def save_model(args, epoch, model, model_without_ddp, optimizer, loss_scaler,model_name=''):
    ...
    if loss_scaler is not None:
        if model_name =='':
            ...
            checkpoint_paths = [output_dir / (f'{model_name}-{epoch_name}.pth' )]
...
def calculate_f1(confusion_matrix):
    ...
    for class_name in confusion_matrix.index:
        ...
        fn = confusion_matrix[class_name].sum() - tp
